...
resource "aws_iam_role" "task_role_for_app" { #
  name               = "task_role_for_${var.app_slug}-${var.account_id}-${var.env}"
...
resource "aws_iam_policy" "app_efs_policy" { #
  name = "app_role_efs_policy-${var.app_slug}-${var.account_id}-${var.env}"
...
resource "aws_iam_role" "execution_role_for_app" { #
  name               = "execution_role_for_${var.app_slug}-${var.account_id}-${var.env}"
...
resource "aws_iam_policy" "app_execution_role_policy" { #
  name = "${var.app_slug}_task_execution_role_policy-${var.account_id}-${var.env}"
