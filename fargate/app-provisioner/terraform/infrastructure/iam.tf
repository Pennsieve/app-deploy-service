...
resource "aws_iam_role" "task_role_for_app" { #
  name               = "task_role_for_app-${var.account_id}-${var.env}"
...
resource "aws_iam_policy" "app_efs_policy" { #
  name = "app_role_efs_policy-${var.account_id}-${var.env}"
...
resource "aws_iam_role" "execution_role_for_app" { #
  name               = "execution_role_for_app-${var.account_id}-${var.env}"
...
resource "aws_iam_policy" "app_execution_role_policy" { #
  name = "app_task_execution_role_policy-${var.account_id}-${var.env}"
